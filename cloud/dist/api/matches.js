...
function sideFor(m, userId) {
    if (Number(m.p1) === userId)
        return "p1";
    if (m.p2 != null && Number(m.p2) === userId)
        return "p2";
    return null;
}
