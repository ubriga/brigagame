...
const CONFIG = {
  ...
  POLL_MIN_MS: 800,
  POLL_MAX_MS: 2600,
  // WebSocket acceleration: match events push over a socket and trigger an
  // immediate snapshot fetch; polling remains as the fallback transport.
  WS_ENABLED: true,
  WS_SAFETY_POLL_MS: 15000,
  POLL_HIDDEN_MS: 5000,
