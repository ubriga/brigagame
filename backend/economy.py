...
CATALOG = {
    ...
    "skin_emerald": {
        ...
        "colors": ["#10b981", "#065f46"], "desc_he": "מראה מגדל ירוק-מרקט.",
    },
    "skin_crimson": {
        "kind": "skin", "name": "Crimson", "name_he": "ארגמן", "price": 250,
        "colors": ["#ef4444", "#7f1d1d"], "desc_he": "מראה מגדל אדום-ארגמן.",
    },
    "skin_royal": {
        "kind": "skin", "name": "Royal", "name_he": "מלכותי", "price": 250,
        "colors": ["#8b5cf6", "#4c1d95"], "desc_he": "מראה מגדל סגול מלכותי.",
    },
    "skin_gold": {
        "kind": "skin", "name": "Gold", "name_he": "זהב", "price": 600,
        "colors": ["#f59e0b", "#92400e"], "desc_he": "מראה מגדל זהב יוקרתי.",
    },
}

DEFAULT_SKIN = {"colors": ["#3b82f6", "#1e3a8a"]}
